#######################################################################
# Makefile for STM32F072B DISCO projects

PROJECT = main
CUBE_PATH ?= STM32CubeF0
HEAP_SIZE = 0x100
...
SOURCES_S = ${CUBE_PATH}/Drivers/CMSIS/Device/ST/STM32F0xx/Source/Templates/gcc/startup_stm32f072xb.s

SOURCES_C = src/main.c

SOURCES_C += sys/stubs.c sys/_sbrk.c
SOURCES_C += ${CUBE_PATH}/Drivers/CMSIS/Device/ST/STM32F0xx/Source/Templates/system_stm32f0xx.c
SOURCES_C += ${CUBE_PATH}/Drivers/BSP/STM32F072B-Discovery/stm32f072b_discovery.c
SOURCES_C += ${CUBE_PATH}/Drivers/STM32F0xx_HAL_Driver/Src/stm32f0xx_hal_gpio.c
...
INCLUDES += -I ${CUBE_PATH}/Drivers/CMSIS/Device/ST/STM32F0xx/Include
INCLUDES += -I ${CUBE_PATH}/Drivers/STM32F0xx_HAL_Driver/Inc
INCLUDES += -I ${CUBE_PATH}/Drivers/BSP/STM32F072B-Discovery

DEFINES = -DSTM32 -DSTM32F0 -DSTM32F072xB
...
MCUFLAGS = -mcpu=cortex-m0 -mlittle-endian
...
LDFLAGS += -L ${CUBE_PATH}/Projects/STM32F072B-Discovery/Templates/SW4STM32/STM32F072B-Discovery/ -T STM32F072RBTx_FLASH.ld
